...
\subsubsection*{(iv)} 
Die Varianz einer Variable beschreibt die mittlere quadratische Abweichung zum Erwartungswert. Die Standardabweichung ist die durchschnittliche Varianz aller Variablen. Sie ist die positive Wurzel aus der Varianz.
\subsubsection*{(v)} 
