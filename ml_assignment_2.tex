...
\begin{itemize}
	\item[b)] Setosa:\\
		...
		Die Daten sind mehr oder weniger normalverteilt, aber es gibt ab und an Wert-Intervalle die in den Trainingsdaten nicht auftauchen. Dies ist vorallem bemerkenswert, weil oft Intervalle mit nächst kleineren und nächst größeren Werten sehr häufig sind. Die Verteilungen sind für die jeweiligen Arten recht unterschiedlich. So ist beispielsweise die petale Länge der Versicolor nach rechts geneigt, während die der Virginica nach links geneigt ist.\\
