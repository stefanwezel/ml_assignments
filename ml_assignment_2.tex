...
\subsection*{(d)}
Da es in der Grundmenge des Wahrscheinlichkeitsraums lediglich zwei Elemente ($\omega_1, \omega_2$) gibt, und die die Summe des Ergebnisses der jeweiligen Maße 1 ergeben muss addieren sie sich jeweils zu 1 auf.
\\
